...
<!--begin::Body-->
<body id="kt_body" style="background-image: url(view/assets/media/patterns/header-bg.png)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
    <!--begin::Main-->
    <!--begin::Root-->
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <!--end::Toolbar-->
                <!--begin::Container-->
				<?php include "partials/lista/busqueda.php"; ?>
                <!--end::Container-->
                <!--begin::Footer-->
